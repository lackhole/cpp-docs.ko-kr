...
|&nbsp;&nbsp;[P0859R0 CWG 1581: constexpr 멤버 함수는 언제 정의되나요?](https://wg21.link/P0859R0)|아니요|
...
|&nbsp;&nbsp;[P0515R3 Three-way (spaceship) comparison operator <=>](https://wg21.link/P0515R3)(P0515R3 3방향(우주선) 비교 연산자 <=>) 및 [P0905R1 Symmetry for spaceship](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0905r1.html)(P0905R1 우주선 대칭)|VS 2019 16.0 <sup>[20](#note_20)</sup>|
...
|&nbsp;&nbsp;[P0306R4 Adding \_\_VA_OPT\_\_ for comma omission and comma deletion](https://wg21.link/P0306R4)(P0306R4 쉼표 생략 및 쉼표 삭제를 위해 __VA_OPT__ 추가) 및 [P1042R1 \_\_VA_OPT\_\_ wording clarifications](https://wg21.link/P1042R1)(P1042R1 __VA_OPT__ 단어 간단한 설명)|아니요|
...
|&nbsp;&nbsp;[P1164R1 Making create_directory() Intuitive (Defect report)](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2019/p1164r1.pdf)(P1164R1 create_directory()를 직관적으로 만들기(결함 보고서))|VS 2019 16.0 <sup>[20](#note_20)</sup>|
...
|&nbsp;&nbsp;[P0220R1 라이브러리 기본 사항 V1](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2016/p0220r1.html)|VS 2017 15.6 <sup>[F](#note_F)</sup>|
...
__VS 2019 16.1__은 Visual Studio 2019 버전 16.1에서 지원되는 기능을 나타냅니다.<br/>
...
<a name="note_F"></a>__F__ Visual Studio 2015에서 완전하지 않은 기능은 이 표의 다른 곳에 나와 있습니다.
...
<a name="note_20"></a>__20__ 이 기능은 [/std:c++latest](../build/reference/std-specify-language-standard-version.md) 컴파일러 옵션을 통해 사용할 수 있습니다. C++20 구현이 완료되면 새 **/std:c++20** 컴파일러 옵션이 추가됩니다.
