...
ATL 등록자 시스템 레지스트리에 사용자 지정 인터페이스를 통해 최적화 된 액세스를 제공합니다. 등록 기관은 자유 및에 대 한 코드의 정적 링크를 허용 C++ 클라이언트입니다.
...
[등록자 코드에 대 한 정적 링크 설정 (C++ 만)](../atl/setting-up-a-static-link-to-the-registrar-code-cpp-only.md)<br/>
