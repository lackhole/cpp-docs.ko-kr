...
ms.locfileid: "75298638"
---
# <a name="queryinterface"></a>QueryInterface

개체가 인스턴스화되기 전에 정적으로 제공하는 기능을 표현할 수 있는 메커니즘이 있지만, 기본적으로 COM 메커니즘은 [QueryInterface](/windows/win32/api/unknwn/nf-unknwn-iunknown-queryinterface(q))라는 `IUnknown` 메서드를 사용합니다.
