...
- **Interface**
   ...
   |옵션|설명|
   |------------|-----------------|
   |**Dual**|개체가 이중 인터페이스를 지원 하도록 지정 합니다. 해당 vtable에는 사용자 지정 인터페이스 함수 및 런타임에 `IDispatch` 바인딩 메서드가 있습니다. COM 클라이언트와 [자동화 컨트롤러](../../mfc/automation-clients.md) 모두에서 개체에 액세스할 수 있습니다. 기본값입니다.|
