...
|[__addfsdword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsdword (unsigned, 부호 없는 long)|
...
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|부호 없는 short __readfsword(unsigned long)|
...
|[__writefsdword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsdword (unsigned, 부호 없는 long)|
...
[(amd64) x64 내장 함수](x64-amd64-intrinsics-list.md)
