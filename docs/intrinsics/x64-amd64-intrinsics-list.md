...
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|unsigned char _addcarry_u32 (unsigned char, 부호 없는 정수, 부호 없는 정수, 부호 없는 int \*)|
...
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8 (unsigned char, 부호 없는 문자, 부호 없는 문자, 부호 없는 문자 \*)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|unsigned char _addcarryx_u32 (unsigned char, 부호 없는 정수, 부호 없는 정수, 부호 없는 int \*)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|unsigned char _addcarryx_u64 (unsigned char unsigned \__int64, 서명 되지 않은 \__int64, 서명 되지 않은 \__int64 \*)|
...
|[_BitScanForward64](bitscanforward-bitscanforward64.md)||intrin.h|unsigned char _BitScanForward64 (부호 없는 long\*부호 없는 \__int64)|
|[_BitScanReverse](bitscanreverse-bitscanreverse64.md)||intrin.h|unsigned char _BitScanReverse (부호 없는 long\*부호 없는 long)|
|[_BitScanReverse64](bitscanreverse-bitscanreverse64.md)||intrin.h|unsigned char _BitScanReverse64 (부호 없는 long\*부호 없는 \__int64)|
|[_bittest](bittest-bittest64.md)||intrin.h|unsigned char _bittest (긴 상수 \*, long)|
|[_bittest64](bittest-bittest64.md)||intrin.h|unsigned char _bittest64(\__int64 const \*, \__int64)|
|[_bittestandcomplement](bittestandcomplement-bittestandcomplement64.md)||intrin.h|unsigned char _bittestandcomplement (장기 \*, long)|
...
|[_bittestandreset](bittestandreset-bittestandreset64.md)||intrin.h|unsigned char _bittestandreset (장기 \*, long)|
|[_bittestandreset64](bittestandreset-bittestandreset64.md)||intrin.h|unsigned char _bittestandreset64(\__int64 \*, \__int64)|
|[_bittestandset](bittestandset-bittestandset64.md)||intrin.h|unsigned char _bittestandset (장기 \*, long)|
...
|[__emulu](emul-emulu.md)||intrin.h|부호 없는 __int64 [pascal/cdecl]\__emulu (부호 없는 정수, 부호 없는 int)|
...
|[__inbytestring](inbytestring.md)||intrin.h|void __inbytestring (즉, 부호 없는 문자 부호 없는 \*부호 없는 long)|
...
|[__indword](indword.md)||intrin.h|부호 없는 long __indword(unsigned short)|
|[__indwordstring](indwordstring.md)||intrin.h|void __indwordstring (unsigned short, 부호 없는 long \*부호 없는 long)|
...
|[_InterlockedAnd_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _interlockedexchangepointer (long volatile \*, long)|
|[_InterlockedAnd_HLERelease](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _interlockedexchangepointer (long volatile \*, long)|
|[_InterlockedAnd_np](interlockedand-intrinsic-functions.md)||intrin.h|긴 _InterlockedAnd_np (장기 \*, long)|
...
|[_InterlockedAnd64_HLEAcquire](interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLEAcquire (\_volatile _int64 \*, \__int64)|
...
|[_interlockedbittestandreset](interlockedbittestandreset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandreset (장기 \*, long)|
|[_interlockedbittestandreset_HLEAcquire](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLEAcquire (장기 \*, long)|
|[_interlockedbittestandreset_HLERelease](interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandreset_HLERelease (장기 \*, long)|
...
|[_interlockedbittestandset](interlockedbittestandset-intrinsic-functions.md)||intrin.h|unsigned char _interlockedbittestandset (장기 \*, long)|
|[_interlockedbittestandset_HLEAcquire](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLEAcquire (장기 \*, long)|
|[_interlockedbittestandset_HLERelease](interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|unsigned char _interlockedbittestandset_HLERelease (장기 \*, long)|
...
|[_InterlockedCompareExchange](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|긴 _InterlockedCompareExchange (long volatile \*, long, long)|
|[_InterlockedCompareExchange_HLEAcquire](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedCompareExchange_HLEAcquire (long volatile \*, long, long)|
|[_InterlockedCompareExchange_HLERelease](interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedCompareExchange_HLERelease (long volatile \*, long, long)|
|[_InterlockedCompareExchange_np](interlockedcompareexchange-intrinsic-functions.md)||intrin.h|긴 _InterlockedCompareExchange_np (긴 \*, long, long)|
...
|[_InterlockedExchange](interlockedexchange-intrinsic-functions.md)||intrin.h|긴 _interlockedexchangepointer (long volatile \*, long)|
|[_InterlockedExchange_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedExchange_HLEAcquire (long volatile \*, long)|
|[_InterlockedExchange_HLERelease](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedExchange_HLERelease (long volatile \*, long)|
...
|[_InterlockedExchange64_HLEAcquire](interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchange64_HLEAcquire (\_volatile _int64 \*, \__int64)|
...
|[_InterlockedExchangeAdd](interlockedexchangeadd-intrinsic-functions.md)||intrin.h|긴 _InterlockedExchangeAdd (long volatile \*, long)|
|[_InterlockedExchangeAdd_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _interlockedexchangepointer (long volatile \*, long)|
|[_InterlockedExchangeAdd_HLERelease](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _interlockedexchangepointer (long volatile \*, long)|
...
|[_InterlockedExchangeAdd64_HLEAcquire](interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchangeAdd64_HLEAcquire (\_volatile _int64 \*, \__int64)|
...
|[_InterlockedExchangePointer_HLEAcquire](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void \* _interlockedexchangepointer (void \*volatile \*, void \*)|
...
|[_InterlockedOr_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedOr_HLEAcquire (long volatile \*, long)|
|[_InterlockedOr_HLERelease](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedOr_HLERelease (long volatile \*, long)|
...
|[_InterlockedOr64_HLEAcquire](interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedOr64_HLEAcquire (\_volatile _int64 \*, \__int64)|
...
|[_InterlockedXor_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedXor_HLEAcquire (long volatile \*, long)|
|[_InterlockedXor_HLERelease](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|긴 _InterlockedXor_HLERelease (long volatile \*, long)|
|[_InterlockedXor_np](interlockedxor-intrinsic-functions.md)||intrin.h|긴 _InterlockedXor_np (장기 \*, long)|
|[_InterlockedXor16](interlockedxor-intrinsic-functions.md)||intrin.h|짧은 _InterlockedXor16 (volatile \*, short)|
...
|[_InterlockedXor64_HLEAcquire](interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedXor64_HLEAcquire (\_volatile _int64 \*, \__int64)|
...
|[__inwordstring](inwordstring.md)||intrin.h|void __inwordstring (unsigned short 즉, 부호 없는 \*부호 없는 long)|
|_lgdt||intrin.h|void _lgdt(void\*)|
|[__lidt](lidt.md)||intrin.h|void __lidt(void\*)|
|[__ll_lshift](ll-lshift.md)||intrin.h|부호 없는 __int64 [pascal/cdecl] \__ll_lshift (unsigned \__int64, int)|
...
|__lwpins32|LWP [1]|ammintrin.h|unsigned char __lwpins32 (unsigned int, 부호 없는 정수, 부호 없는 int)|
|__lwpins64|LWP [1]|ammintrin.h|unsigned char __lwpins64 (부호 없는 \__int64, 부호 없는 int unsigned int)|
|__lwpval32|LWP [1]|ammintrin.h|void __lwpval32 (unsigned int, 부호 없는 정수, 부호 없는 int)|
...
|[_mm_crc32_u8](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_crc32_u8)|SSE42|intrin.h|unsigned int _mm_crc32_u8 (부호 없는 정수, 부호 없는 문자)|
...
|[__movsb](movsb.md)||intrin.h|VOID __movsb (unsigned char \*부호 없는, const char \*, size_t)|
|[__movsd](movsd.md)||intrin.h|VOID __movsd (부호 없는 long \*부호 없는 long const \*, size_t)|
|[__movsq](movsq.md)||intrin.h|VOID __movsq (부호 없는 \__int64 \*부호 없는 \__int64 const \*, size_t)|
|[__movsw](movsw.md)||intrin.h|VOID __movsw (unsigned short \*, 부호 없는 short const \*, size_t)|
...
|[__outbytestring](outbytestring.md)||intrin.h|void __outbytestring (즉, 부호 없는 문자 부호 없는 \*부호 없는 long)|
|[__outdword](outdword.md)||intrin.h|void __outdword (부호 없는 short, 부호 없는 long)|
|[__outdwordstring](outdwordstring.md)||intrin.h|void __outdwordstring (unsigned short, 부호 없는 long \*부호 없는 long)|
|[__outword](outword.md)||intrin.h|void __outword(unsigned short, unsigned short)|
|[__outwordstring](outwordstring.md)||intrin.h|void __outwordstring (unsigned short 즉, 부호 없는 \*부호 없는 long)|
...
|[__readgsword](readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|부호 없는 short __readgsword(unsigned long)|
...
|[__segmentlimit](segmentlimit.md)||intrin.h|부호 없는 long __segmentlimit(unsigned long)|
|_sgdt||intrin.h|void _sgdt(void\*)|
|[__shiftleft128](shiftleft128.md)||intrin.h|부호 없는 __int64 \__shiftleft128 (unsigned \__int64, 서명 되지 않은 \__int64, 부호 없는 문자)|
...
|[__svm_invlpga](svm-invlpga.md)||intrin.h|__svm_invlpga void (void\*, int)|
...
|[__ull_rshift](ull-rshift.md)||intrin.h|부호 없는 __int64 [pascal/cdecl] \__ull_rshift (unsigned \__int64, int)|
...
|[__writegsdword](writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsdword (unsigned, 부호 없는 long)|
...
[컴파일러 내장 함수](compiler-intrinsics.md)<br/>
[ARM 내장 함수](arm-intrinsics.md)<br/>
