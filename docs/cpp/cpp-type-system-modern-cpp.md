...
**const** 형식은 const가 아닌 버전과 구분됩니다. 예를 들어 **const int**는 **int**와는 다른 형식입니다. C++에서 변수에서 const 성격을 제거해야 하는 드문 경우에는 **const_cast** 연산자를 사용할 수 있습니다. 자세한 내용은 [형식 변환 및 형식 안전성](../cpp/type-conversions-and-type-safety-modern-cpp.md)을 참조하세요.
