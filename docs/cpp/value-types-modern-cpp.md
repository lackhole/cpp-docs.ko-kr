...
By using move semantics you can return-by-value or insert-in-middle. Move is an optimization of copy. There is need for heap allocation as a workaround. 다음 의사 코드를 살펴보겠습니다.
...
For a value-like class where move can be cheaper than a deep copy, enable move construction and move assignment for efficiency. 다음 의사 코드를 살펴보겠습니다.
