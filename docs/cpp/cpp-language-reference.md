...
이 참조에 대해서 설명합니다. C++ 프로그래밍 언어를 Microsoft에서 구현한 C++ 컴파일러. 조직을 기반으로 [The Annotated C Reference Manual](http://www.stroustrup.com/arm.html) Margaret Ellis 와 Bjarne Stroustrup 와 ANSI/ISO C 국제 규격 (ISO/IEC FDIS 14882). Microsoft 고유의 C++ 언어 기능의 구현도 포함되어 있습니다. 

모던 C++ 프로그래밍 방법은 [C++의 진화(최신 C++)](welcome-back-to-cpp-modern-cpp.md)를 참조해 주세요.
...
.NET을 대상으로 하는 Microsoft C++ 컴파일러 사용에 대한 자료 참조.
...
시작 페이지로의 다양한 Microsoft의 C++ 라이브러리 참조 링크 목록.
