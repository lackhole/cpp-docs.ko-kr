...
그러나 Microsoft의 이전 버전을 사용 하는 경우 C++ 컴파일러 도구 집합을 지 원하는 **/clr: pure** 및 **/clr: safe**, 프로젝트를 확인할 수로 변환할 수. 이 항목에서는 프로젝트 속성을 설정 하 여 Visual Studio 변환할 프로젝트 소스 파일을 수정 하는 방법을 설명 C++ 프로젝트를 확인할 수 있는 응용 프로그램을 생성 합니다.
