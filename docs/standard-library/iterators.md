...
Visual C++ 이제 제품에 컨테이너의 경계를 덮어쓰지 않도록 하는 반복기 및 디버그 반복기 확인 합니다. 자세한 내용은 [확인된 반복기](../standard-library/checked-iterators.md) 및 [디버그 반복기 지원](../standard-library/debug-iterator-support.md)을 참조하세요.
