...
|[destroy_at](../standard-library/memory-functions.md#destroy_at)|줄임 `destroy` 메서드입니다.|
|[destroy](../standard-library/memory-functions.md#destroy)|줄임 `destroy` 메서드입니다.|
|[destroy_n](../standard-library/memory-functions.md#destroy_n)|줄임 `destroy` 메서드입니다.|
...
|[uninitialized_default_construct](../standard-library/memory-functions.md#uninitialized_default_construct)|줄임 `uninitialized_default_construct` 메서드입니다.|
|[uninitialized_default_construct_n](../standard-library/memory-functions.md#uninitialized_default_construct_n)|줄임 `uninitialized_construct` 메서드입니다.|
...
|[uninitialized_move](../standard-library/memory-functions.md#uninitialized_move)|줄임 `uninitialized_move` 메서드입니다.|
|[uninitialized_move_n](../standard-library/memory-functions.md#uninitialized_move_n)|줄임 `uninitialized_move` 메서드입니다.|
|[uninitialized_value_construct](../standard-library/memory-functions.md#uninitialized_value_construct)|줄임 `uninitialized_value_construct` 메서드입니다.|
|[uninitialized_value_construct_n](../standard-library/memory-functions.md#uninitialized_value_construct_n)|줄임 `uninitialized_value_construct` 메서드입니다.|
...
|[auto_ptr](../standard-library/auto-ptr-class.md)|클래스 템플릿은 바깥쪽 auto_ptr 제거 될 때 요소가 가리키는 개체가 삭제 되도록 하 **는 형식** <strong>\*</strong> 의 할당 된 개체에 대 한 포인터를 저장 하는 개체를 설명 합니다.|
...
|[pointer_traits](../standard-library/pointer-traits-struct.md)|포인터 형식이 `Ptr` 인 할당자를 설명 하기 위해 `allocator_traits` 형식의 개체에 필요한 정보를 제공 합니다.|
...
|hash|@No__t_0 및 `shared_ptr`에 대해 특수화 된 오버 로드를 제공 합니다.|
...
|||
|-|-|
|[allocator\<void>](../standard-library/allocator-void-class.md)|**Void**형식에 대 한 클래스 템플릿 할당자의 특수화로,이 특수화 된 컨텍스트에서 맞는 멤버 형식만 정의 합니다.|
