...
ms.locfileid: "72686689"
---
# <a name="regex_traitsltchargt-class"></a>regex_traits&lt;char&gt; 클래스

**Char**에 대 한 `regex_traits`의 특수화입니다.
...
클래스는 **char** 형식의 요소에 대 한 클래스 템플릿 [regex_traits](../standard-library/regex-traits-class.md) 의 명시적 특수화로,이 형식의 개체를 조작 하는 라이브러리 함수를 활용할 수 있도록 합니다.
