...
> [!IMPORTANT]
> _SECURE_MM 매크로를 직접 사용 하는 것은 더 이상 권장 되지 않습니다. 대신 _ITERATOR_DEBUG_LEVEL를 사용하여 확인 된 반복기 설정을 제어 합니다. 자세한 내용은 [_ITERATOR_DEBUG_LEVEL](../standard-library/iterator-debug-level.md)을 참조하세요.
