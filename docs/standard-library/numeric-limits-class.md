...
*형식*\
속성이 테스트, 쿼리 또는 설정되는 기본 요소 데이터 형식입니다. *형식* 선언할 수도 있습니다 **const**합니다 **volatile**, 또는 **const volatile**합니다.
...
|[has_quiet_NaN](#has_quiet_nan)|숫자가 아님 (NAN)은 비-신호는 형식에는 quiet 표현이 있는지 테스트 합니다.|
