...
|컨트롤의 속성 페이지 또는 페이지를 생성 합니다.|시각적 개체를 사용 하 여 C++ 리소스 편집기를 시각적으로 컨트롤의 속성 페이지 인터페이스를 편집 합니다.<br /><br />-추가 속성 페이지를 만듭니다.<br />-만들기 및 비트맵, 아이콘 및 커서를 편집 합니다.<br /><br /> 또한 대화 상자 편집기의 속성 페이지를 테스트할 수 있습니다.|MFC 응용 프로그램 마법사로 만든 기본 리소스 파일에 필요한 리소스를 많이 제공 합니다. Visual C++ 기존 리소스를 편집 하 고 쉽고 시각적으로 새 리소스를 추가할 수 있습니다.|
