...
프레임워크는 특히 **파일** 메뉴에서 **새로 만들기**와 **열기** 명령의 구현을 제공합니다. 새 문서 및 관련 보기 및 프레임 창 만들기는 응용 프로그램 개체, 문서 템플릿, 새로 만든 문서 및 새로 만든 프레임 창 간의 공동 작업입니다. 다음 표는 어떤 개체가 무엇을 생성하는지에 대한 개요를 보여줍니다.
