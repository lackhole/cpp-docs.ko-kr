...
SDI 응용 프로그램은 한 번에 하나의 열려 있는 문서 프레임 창만 허용합니다. MDI 응용 프로그램은 여러 문서 프레임 창을 동일한 응용 프로그램의 인스턴스에서 열 수 있도록 허용합니다. MDI 응용 프로그램에는 여러 개의 MDI 자식 창이 있는 창이 있는데, 이들은 프레임 창으로서 열 수 있으며 각각 개별 문서를 포함합니다. 일부 응용 프로그램에서는 자식 창이 차트 창이나 스프레드시트 창와 같은 다양한 형식이 될 수 있습니다. 이 경우 다른 유형의 MDI 자식 창이 활성화되면 메뉴 표시줄이 변경될 수 있습니다.
