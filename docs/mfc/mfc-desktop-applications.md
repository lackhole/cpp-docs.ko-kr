...
>
>  MBCS(멀티바이트 문자 인코딩)용 MFC 라이브러리(DLL)는 Visual Studio에 더 이상 포함되지 않지만 Visual Studio 추가 기능으로 사용할 수 있습니다. 자세한 내용은 [MFC MBCS DLL 추가 기능](mfc-mbcs-dll-add-on.md)을 참조하세요.
