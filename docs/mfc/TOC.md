...
#### [MFC 애플리케이션을 빌드하는 작업 시퀀스](sequence-of-operations-for-building-mfc-applications.md)
#### [OLE 애플리케이션을 만드는 작업 시퀀스](sequence-of-operations-for-creating-ole-applications.md)
#### [ActiveX 컨트롤을 만드는 작업 시퀀스](sequence-of-operations-for-creating-activex-controls.md)
#### [데이터베이스 애플리케이션을 만드는 작업 시퀀스](sequence-of-operations-for-creating-database-applications.md)
#### [프레임워크가 코드를 호출하는 방법](how-the-framework-calls-your-code.md)
### [CWinApp: 애플리케이션 클래스](cwinapp-the-application-class.md)
#### [CWinApp 및 MFC 애플리케이션 마법사](cwinapp-and-the-mfc-application-wizard.md)
...
### [CObject 클래스: 자주 묻는 질문](cobject-class-frequently-asked-questions.md)
...
#### [메모리 관리: 예제](memory-management-examples.md)
...
#### [활성 문서 포함의 예: Office Binder](example-of-active-document-containment-office-binder.md)
#### [액티브 문서 컨테이너 애플리케이션 만들기](creating-an-active-document-container-application.md)
...
### [Serialization: 직렬화할 수 있는 클래스 만들기](serialization-making-a-serializable-class.md)
...
### [Serialization: Serialization 및 데이터베이스 입출력 비교](serialization-serialization-vs-database-input-output.md)
#### [입력-출력 처리에 대한 권장 사항](recommendations-for-handling-input-output.md)
#### [MFC 데이터베이스 애플리케이션의 파일 메뉴](file-menu-in-an-mfc-database-application.md)
...
##### [MFC ActiveX 컨트롤: ActiveX 컨트롤에서 그림 사용](mfc-activex-controls-using-pictures-in-an-activex-control.md)
...
##### [MFC ActiveX 컨트롤: ActiveX 컨트롤 라이선스 획득](mfc-activex-controls-licensing-an-activex-control.md)
...
### [클립보드](clipboard.md)
#### [클립보드: 클립보드 메커니즘을 사용하는 경우](clipboard-when-to-use-each-clipboard-mechanism.md)
...
#### [예제: 메뉴 명령을 통해 대화 상자 표시](example-displaying-a-dialog-box-via-a-menu-command.md)
...
#### [연습: 애플리케이션에 CTaskDialog 추가](walkthrough-adding-a-ctaskdialog-to-an-application.md)
...
#### [MFC 애플리케이션 마법사에서 만든 문서 및 뷰 클래스](document-and-view-classes-created-by-the-mfc-application-wizard.md)
...
#### [애플리케이션에서 속성 시트 사용](using-property-sheets-in-your-application.md)
...
#### [방법: 애플리케이션 단추 사용자 지정](how-to-customize-the-application-button.md)
...
#### [방법: MFC 애플리케이션에서 리본 리소스 로드](how-to-load-a-ribbon-resource-from-an-mfc-application.md)
#### [연습: MFC를 사용하여 리본 애플리케이션 만들기](walkthrough-creating-a-ribbon-application-by-using-mfc.md)
#### [연습: MFC 자유 곡선 애플리케이션 업데이트(1부)](walkthrough-updating-the-mfc-scribble-application-part-1.md)
#### [연습: MFC 자유 곡선 애플리케이션 업데이트(2부)](walkthrough-updating-the-mfc-scribble-application-part-2.md)
...
###### [애플리케이션 마법사로 만든 프레임 창 클래스](frame-window-classes-created-by-the-application-wizard.md)
...
#### [Windows 소켓: 배경](windows-sockets-background.md)
...
#### [Windows 소켓: 소켓 클래스에서 파생](windows-sockets-deriving-from-socket-classes.md)
...
### [인터넷 클라이언트 애플리케이션을 만들기 위한 MFC 클래스](mfc-classes-for-creating-internet-client-applications.md)
...
### [일반적인 인터넷 클라이언트 애플리케이션의 단계](steps-in-a-typical-internet-client-application.md)
### [일반적인 FTP 클라이언트 애플리케이션의 단계](steps-in-a-typical-ftp-client-application.md)
### [일반적인 FTP 클라이언트 애플리케이션에서 파일을 삭제하는 단계](steps-in-a-typical-ftp-client-application-to-delete-a-file.md)
### [일반적인 Gopher 클라이언트 애플리케이션의 단계](steps-in-a-typical-gopher-client-application.md)
### [일반적인 HTTP 클라이언트 애플리케이션의 단계](steps-in-a-typical-http-client-application.md)
...
## [TN037: 다중 스레드 MFC 2.1 애플리케이션](tn037-multithreaded-mfc-2-1-applications.md)
...
## [TN048: MFC 데이터베이스 애플리케이션에 대한 ODBC 설정 및 관리 프로그램 작성](tn048-writing-odbc-setup-and-administration-programs.md)
...
## [TN055: MFC ODBC 데이터베이스 클래스 애플리케이션을 MFC DAO 클래스로 마이그레이션](tn055-migrating-mfc-odbc-database-class-applications-to-mfc-dao-classes.md)
## [TN056: 지역화된 MFC 구성 요소 설치](tn056-installation-of-localized-mfc-components.md)
## [TN057: MFC 구성 요소의 지역화](tn057-localization-of-mfc-components.md)
...
### [애플리케이션 프레임워크](application-framework.md)
