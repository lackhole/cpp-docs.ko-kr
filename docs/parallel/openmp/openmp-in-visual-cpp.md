...
ms.locfileid: "62362649"
---
# <a name="openmp-in-visual-c"></a>Visual C++의 OpenMP

OpenMP C 및 C++ 응용 프로그램 인터페이스를 사용 하면 효과적으로 여러 프로세서를 사용 하는 응용 프로그램을 작성할 수 있습니다. Visual C++ OpenMP 2.0 표준을 지원 합니다.
...
미리 정의 된 ANSI C 및 Microsoft 이름을 C++ 매크로 구현 합니다. _OPENMP 매크로 참조 하세요.