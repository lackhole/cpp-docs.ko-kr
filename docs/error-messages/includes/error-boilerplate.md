...
Microsoft의 공개 포럼에서 오류 및 경고에 대 한 추가 지원을 찾아볼 수도 있습니다. 또는 Visual Studio에서 경고 번호는 오류 검색 C++ [개발자 커뮤니티](https://developercommunity.visualstudio.com/spaces/8/index.html) 사이트입니다. 오류 및 경고를 검색 하 고에 대 한 질문 수도 있습니다 [Stack Overflow](https://stackoverflow.com/) 솔루션을 찾으려고 합니다.
