...
ms.locfileid: "58781499"
---
# <a name="linker-tools-error-lnk1000"></a>링커 도구 오류 LNK1000

> 알 수 없는 오류입니다. 기술 지원 옵션에 대 한 설명서를 참조 하세요.

오류 상황을 파악 하는 시도 문제를 파악 하 여 재현 가능한 테스트 사례를 만듭니다. 조사 하 고 이러한 오류를 보고 하는 방법에 대 한 자세한 내용은 [Visual c + + 도구 집합 또는 문서를 사용 하 여 문제를 보고 하는 방법을](../../overview/how-to-report-a-problem-with-the-visual-cpp-toolset.md)합니다.
