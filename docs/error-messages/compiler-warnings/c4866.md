...
이 경고는 C + + 17 표준에 대 한 컴파일러 규칙 작업의 결과로 15.9 Visual Studio 2017 버전에서 도입 되었습니다. 버전의 Visual 전에 컴파일러에서 경고 없이 컴파일되는 코드 C++ 2017 버전 15.9 생성할 수 있습니다 **C4866**합니다. 이상 특정 컴파일러 버전에서 도입 된 경고를 사용 하지 않도록 설정 하는 방법에 대 한 자세한 내용은 [컴파일러 버전별 컴파일러 경고](compiler-warnings-by-compiler-version.md)합니다.
