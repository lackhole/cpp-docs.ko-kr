...
ms.locfileid: "62303349"
---
# <a name="compiler-error-c2071"></a>컴파일러 오류 C2071

identifier': 스토리지 클래스가 잘못되었습니다

`identifier` 잘못 된 선언 된 [저장소 클래스](../../c-language/c-storage-classes.md)합니다. 식별자에 대해 둘 이상의 스토리지 클래스를 지정하거나 정의가 스토리지 클래스 선언과 호환되지 않는 경우 이 오류가 발생할 수 있습니다.
