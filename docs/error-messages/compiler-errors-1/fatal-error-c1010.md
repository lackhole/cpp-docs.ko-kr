...
ms.locfileid: "62363975"
---
# <a name="fatal-error-c1010"></a>심각한 오류 C1010

미리 컴파일된 헤더를 찾는 동안 예기치 않은 파일의 끝이 나타났습니다. 추가 했는지 ' #include 이름 ' 소스에?

지정 된 포함 파일 [/Yu](../../build/reference/yu-use-precompiled-header-file.md) 소스 파일에 나열 되지 합니다.  대부분의 시각적 개체에는 기본적으로이 옵션은 C++ 프로젝트 형식 및 "stdafx.h"가 기본이이 옵션으로 지정 된 파일을 포함 합니다.
