...
C3821은 vararg 함수에 자동 저장소를 사용 하려는 경우에 발생할 수 있습니다.  자세한 내용은 참조 하세요. [가변 인수 목록 (...) (C + + /CLI CLI) ](../../extensions/variable-argument-lists-dot-dot-dot-cpp-cli.md) 하 고 [참조 형식에 대 한 c + + 스택 의미 체계](../../dotnet/cpp-stack-semantics-for-reference-types.md)합니다.
