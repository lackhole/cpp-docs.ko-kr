---
title: '방법: const 키워드를 사용하여 내부 포인터 선언(C++/CLI)'
ms.date: 10/12/2018
ms.topic: reference
helpviewer_keywords:
- pointers, interior
...
ms.locfileid: "65515778"
---
# <a name="how-to-declare-interior-pointers-with-the-const-keyword-ccli"></a>방법: const 키워드를 사용하여 내부 포인터 선언(C++/CLI)
