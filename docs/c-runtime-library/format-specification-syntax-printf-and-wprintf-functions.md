...
> [!NOTE]
> **Microsoft 전용:** **I** (대문자 I), **I32**, **I64**및 **w** 인수 크기 한정자 접두사는 Microsoft 확장 이며 ISO C와 호환 되지 않습니다. `char` 형식의 데이터와 함께 사용되는 **h** 접두사 및 `double` 형식의 데이터와 함께 사용되는 **l**(소문자 L) 접두사는 Microsoft 확장입니다.
