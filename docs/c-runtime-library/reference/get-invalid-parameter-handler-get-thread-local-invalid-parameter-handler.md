...
**_Get_invalid_parameter_handler** 및 **_Get_thread_local_invalid_parameter_handler** 함수는 Microsoft 전용입니다. 호환성에 대한 자세한 내용은 [호환성](../../c-runtime-library/compatibility.md)을 참조하세요.
