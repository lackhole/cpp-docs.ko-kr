...
ms.locfileid: "70740496"
---
# <a name="deprecating-types-and-members-ccx"></a>형식 및 멤버가 사용되지 않도록 지정(C++/CX)

/Cx C++에서는 [더 이상 사용 되지 않는](/uwp/api/windows.foundation.metadata.deprecatedattribute) 특성을 사용 하 여 생산자 및 소비자에 대 한 Windows 런타임 형식 및 멤버를 사용할 수 없습니다. 이 속성이 적용된 API를 사용하는 경우 API가 더 이상 사용되지 않음을 나타내고 대체 API를 사용하도록 권장하는 컴파일 타임 경고 메시지가 나타납니다. public 형식 및 메서드에서 이 특성을 적용하고 사용자 지정 메시지를 제공할 수 있습니다.
