...
사용자 인터페이스를 만들 수 있습니다 C# 사용 C++/CLI 네이티브를 사용 하는 응용 프로그램을 사용 하도록 설정 하려면 C++ 라이브러리입니다. 자세한 내용은 [C++/CLI를 이용한 .NET 프로그래밍](../dotnet/dotnet-programming-with-cpp-cli-visual-cpp.md)을 참조하세요.
