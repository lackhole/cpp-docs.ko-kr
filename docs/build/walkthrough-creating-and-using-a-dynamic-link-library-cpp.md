...
>
>1. 왼쪽된 창에는 **속성 페이지** 대화 상자에서 **전처리기** 아래에 있는 **구성 속성** > **C/c + +**. 콘텐츠를 확인 합니다 **전처리기 정의** 속성입니다.<br/><br/>![전처리기 정의 속성을 확인 하십시오](media/mathlibrary-153bug-preprocessor-definitions-check.png "전처리기 정의 속성 확인")<br/><br/>표시 되 면 **MATHLIBRARY&#95;EXPORTS** 에 **전처리기 정의** 목록에서 아무 것도 변경 해야 합니다. 표시 되 면 **MathLibrary&#95;EXPORTS** 대신 다음이 단계를 수행 하려면 다음 계속 합니다.
>
