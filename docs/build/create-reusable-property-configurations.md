...
ms.locfileid: "68313185"
---
# <a name="share-or-reuse-visual-studio-project-settings"></a>Visual Studio 프로젝트 설정 공유 또는 재사용

다른 사용자와 공유 하거나 여러 프로젝트에서 다시 사용할 수 있는 설정의 사용자 지정 그룹을 만들려면 **속성 관리자** 를 사용 하 여 *속성 시트* (props 파일)를 만들어 다시 사용 하거나 공유할 수 있는 각 프로젝트 종류에 대 한 설정을 저장 합니다. 다른 사용자와 함께. 속성 시트를 사용 하면 "전역" 설정을 만드는 다른 방법 보다 훨씬 더 오류가 발생 하기 쉽습니다. 
...
**속성 관리자**표시 하려면 메뉴 모음에서 **보기** > **속성 관리자** 를 선택 하거나 설정에 따라**다른 Windows** > **속성 관리자** **보기** > 를 선택 합니다.
...
1. 메뉴 모음에서**속성 관리자** **보기** > 를 선택 하거나**다른 Windows** > **속성 관리자** **보기** > 를 선택 합니다. **속성 관리자**가 열립니다.
