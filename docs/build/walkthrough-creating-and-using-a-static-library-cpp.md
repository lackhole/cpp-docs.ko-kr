...
description: 사용 하 여 C++ Visual Studio에서 정적 라이브러리 (.lib)을 만들려고 합니다.
...
프로젝트를 만드는 방법에 대 한 지침은 Visual Studio 2019 또는 이전 버전을 사용 하는지에 따라 달라 집니다. 이 페이지의 왼쪽 위에 있는 설정 올바른 버전이 있는지 확인 합니다.

::: moniker range="vs-2019"

### <a name="to-create-a-static-library-project-in-visual-studio-2019"></a>Visual Studio 2019에 정적 라이브러리 프로젝트를 만들려면

1. 메뉴 모음에서 **파일** > **새로 만들기** > **프로젝트** 열려는 합니다 **새 프로젝트를 만들** 대화 상자.

1. 설정 대화 상자 맨 **언어** 를 **C++** 설정 **플랫폼** 하 **Windows**, 설정 및 **프로젝트 형식을** 하 **라이브러리**합니다. 

1. 필터링된 된 프로젝트 형식 목록에서 선택 **정적 라이브러리** 선택한 **다음**합니다. 다음 페이지에서 입력 *MathFuncsLib* 에 **이름** 상자에 프로젝트의 이름을 지정 하 고 원하는 경우 프로젝트 위치를 지정 합니다.
...
1. 아래 **추가 옵션**의 **미리 컴파일된 헤더** 확인란을 선택 취소합니다.
...
### <a name="to-create-a-c-console-app-that-references-the-static-library-in-visual-studio-2019"></a>만들려는 C++ Visual Studio 2019에서 정적 라이브러리를 참조 하는 콘솔 앱

1. **솔루션 탐색기**솔루션의 최상위 노드를 마우스 오른쪽 단추로 클릭 하 고 선택 **추가** > **새 프로젝트** 열려는 **새 프로젝트 추가**  대화 상자.

1. 설정 대화 상자 맨 **언어** 를 **C++** 설정 **플랫폼** 하 **Windows**, 설정 및 **프로젝트 형식을** 하 **콘솔**합니다. 

1. 필터링된 된 프로젝트 형식 목록에서 선택 **콘솔 앱** 선택한 **다음**합니다. 다음 페이지에서 입력 *MyExecRefsLib* 에 **이름** 상자에 프로젝트의 이름을 지정 하 고 원하는 경우 프로젝트 위치를 지정 합니다.
...
### <a name="to-create-a-c-console-app-that-references-the-static-library-in-visual-studio-2017"></a>만들려는 C++ Visual Studio 2017에서 정적 라이브러리를 참조 하는 콘솔 앱
...
### <a name="to-create-a-c-console-app-that-references-the-static-library-in-visual-studio-2015"></a>만들려는 C++ Visual Studio 2015에서 정적 라이브러리를 참조 하는 콘솔 앱
...
1. 이제 `#include "MathFuncsLib.h"` 헤더를 코드에 포함하여 `MyMathFuncs` 클래스를 사용할 수 있습니다. 다음 코드를 사용하여 `MyExecRefsLib.cpp`의 내용을 바꿉니다.

   [!code-cpp[NVC_Walkthrough_Create_Static_Lib#120](../windows/codesnippet/CPP/walkthrough-creating-and-using-a-static-library-cpp_3.cpp)]

1. **빌드** > **솔루션 빌드** 메뉴 모음에서 선택하여 실행 파일을 빌드합니다 .
