...
지역 변수에 대한 저장소를 필요로 하는 모든 함수 호출에 대한 스택 프로브를 활성화합니다.
...
이 메커니즘은 스택 프로브 기능을 다시 쓸 때 유용합니다. 스택 프로브 기능을 다시 쓰는 대신 [/Gh(_penter 후크 함수 사용)](gh-enable-penter-hook-function.md)를 사용하는 것이 좋습니다.
