...
함수의 반환 주소, 예외 처리기 주소 혹은 특정 유형의 매개 변수가 덮어쓰기되는 버퍼 오버런을 검색 합니다. 버퍼 오버런은 해커가 버퍼 크기 제한을 적용 하지 않는 코드를 사용하여 공격하는 기술입니다.
...
**/GS**는 기본적으로 켜져 있습니다. 보안 위험에 노출 되더라도 옵션을 해제한 응용 프로그램을 원하는 경우 **/GS-**을 사용 합니다. 버퍼 오버런 탐지를 억제 하는 방법에 대한 자세한 내용은 [safebuffers](../../cpp/safebuffers.md)을 참조합니다.
...
- 사용하여 할당 된 버퍼를 [_alloca](../../c-runtime-library/reference/alloca.md) 함수입니다.
