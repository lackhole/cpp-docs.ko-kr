...
생성 된 파일의 형식은 **/GL** 현재 버전에서 읽을 수 없습니다 시각적 개체의 이후 버전에서 C++합니다. 사용 하 여 생성 된.obj 파일의 구성 하는.lib 파일을 제공 해서는 안 **/GL** 시각적 개체의 모든 버전의.lib 파일의 복사본을 제공할 의향이 없다면 C++ 사용자가 사용 하 여, 현재와 미래에 예상 합니다.
