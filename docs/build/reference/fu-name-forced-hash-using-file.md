...
소스 코드 안에서 [#지시문을 이용](../../preprocessor/hash-using-directive-cpp.md)해 파일 이름을 전달하는 방법을 대신할 수 있는 컴파일러 옵션입니다.
...
CLR(공용 언어 런타임) 어셈블리 또는 모듈을 만드는 방법에 대한 정보는 [/clr (공용 언어 런타임 컴파일)](clr-common-language-runtime-compilation.md)을 참조합니다. C++/CX에서 빌드하는 방법에 대한 내용은 [앱 및 라이브러리 빌드](../../cppcx/building-apps-and-libraries-c-cx.md)를 참조합니다.
