...
**/FD** 제외 하 고 사용자에 게 노출 되지 합니다 [명령줄](command-line-property-pages.md) C++ 프로젝트의 속성 페이지 **속성 페이지** 경우에 대화 상자의 [/Gm (최소 다시 빌드 사용)](gm-enable-minimal-rebuild.md) 도 선택 하지 않습니다. **/FD** 개발 환경에서 다른 효과가 있습니다. **/FD** 의 출력에 표시 되지 않습니다 **cl /?** 합니다.
