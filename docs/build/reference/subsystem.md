...
**BOOT_APPLICATION**<br/>
Windows 부팅 환경에서 실행되는 애플리케이션입니다. 부팅 응용 프로그램에 대 한 자세한 내용은 참조 하세요. [BCD WMI 공급자에 대 한](/previous-versions/windows/desktop/bcd/about-bcd)합니다.
