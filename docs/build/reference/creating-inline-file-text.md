...
지정할 *inlinetext* 명령은 첫 번째 줄에서 합니다. 이중 꺾쇠 괄호를 사용 하 여 끝을 표시 (<<) 별도 줄 시작 부분에 있습니다. 모든 파일 포함 *inlinetext* 대괄호 구분 하기 전에 합니다. 합니다 *inlinetext* 매크로 확장 및 대체 있지만 지시문 또는 메이크파일 주석은 있을 수 있습니다. 공백, 탭 및 줄 바꿈 문자 리터럴로 처리 됩니다.
