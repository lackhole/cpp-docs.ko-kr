...
**0**<br/>
인라인 확장을 사용하지 않도록 설정합니다. 기본적으로 모든 함수에서 컴파일러의 판단에 따라 확장되며 경우에 따라 *자동 인라인*이라고 합니다.
...
[/O1, /O2 (크기 최소화, 속도 최대화)](o1-o2-minimize-size-maximize-speed.md) 또는 하거나 [/Ox (대부분의 속도 최적화 사용)](ox-full-optimization.md)가 사용될 때 **/Ob2**가 적용 됩니다.

이 옵션을 사용하려면 **/O1**, **/O2**, **/Ox** 또는 **/Og**를 사용하여 최적화를 수행해야 합니다.
...
`#pragma` [auto_inline](../../preprocessor/auto-inline.md) 지시문을 사용하여 함수를 인라인 확장 후보 고려 대상에서 제외할 수 있습니다. `#pragma` [intrinsic](../../preprocessor/intrinsic.md) 지시문을 참조합니다.
...
1. **구성 속성**에서 **C/C++**를 선택하고 **최적화**를 선택합니다.
