...
시각적 개체를 사용 하 여 C++, C에서 Win32 Dll을 빌드할 수 있습니다 또는 C++ Microsoft Foundation 클래스 (MFC) 라이브러리를 사용 하지 않습니다. Win32 응용 프로그램 마법사를 사용 하 여 비 MFC DLL 프로젝트를 만들 수 있습니다.

MFC 라이브러리 자체는 여러 MFC DLL 마법사를 사용 하 여 Dll 또는 정적 연결 라이브러리나에서를 사용할 수 있습니다. DLL에서 MFC, 시각적 개체를 사용 하는 경우 C++ 세 가지의 DLL 개발 시나리오를 지원 합니다.
...
시각적 개체를 사용 하 여 DLL에서 MFC를 사용 하지 않는 경우 C++ 비 MFC Win32 DLL을 빌드할 수 있습니다. 중요 한 디스크 공간 및 메모리를 소모 (정적 또는 동적) DLL을 MFC에 링크 합니다. DLL이 실제로 MFC를 사용 하지 않는 한 MFC에 링크 하지 말아야 합니다.
...
이전 버전 4.0, Visual C++ 에서만 두 종류의 MFC를 사용 하는 Dll 지원 합니다. Usrdll 및 Afxdll 합니다. 정적으로 MFC에 링크 된 기본 MFC Dll은 이전의 usrdll과 같은 특징을 갖습니다. MFC 확장명 Dll은 이전의 afxdll과 같은 특징을 갖습니다.
